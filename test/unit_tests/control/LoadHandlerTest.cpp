...
TEST(ControlLoadHandler, testLoad) {
    auto doc = loadTestDocument(GET_TESTFILE("test1.xoj"));
    ASSERT_TRUE(doc);
...
TEST(ControlLoadHandler, testLoadZipped) {
    auto doc = loadTestDocument(GET_TESTFILE("packaged_xopp/test.xopp"));
    ASSERT_TRUE(doc);
...
TEST(ControlLoadHandler, testLoadUnzipped) {
    auto doc = loadTestDocument(GET_TESTFILE("test1.unzipped.xoj"));
    ASSERT_TRUE(doc);
...
TEST(ControlLoadHandler, testPages) {
    auto doc = loadTestDocument(GET_TESTFILE("load/pages.xopp"));
    ASSERT_TRUE(doc);
...
TEST(ControlLoadHandler, testPagesZipped) {
    auto doc = loadTestDocument(GET_TESTFILE("packaged_xopp/pages.xopp"));
    ASSERT_TRUE(doc);
...
TEST(ControlLoadHandler, testPageTypeFormatCopyFix) {
    auto doc = loadTestDocument(GET_TESTFILE("pageTypeFormatCopy.xopp"));
    ASSERT_TRUE(doc);
...
TEST(ControlLoadHandler, testLayers) {
    auto doc = loadTestDocument(GET_TESTFILE("load/layers.xopp"));
    ASSERT_TRUE(doc);
...
TEST(ControlLoadHandler, testLayerZipped) {
    auto doc = loadTestDocument(GET_TESTFILE("packaged_xopp/layer.xopp"));
    ASSERT_TRUE(doc);
...
TEST(ControlLoadHandler, testStrokes) {
    auto doc = loadTestDocument(GET_TESTFILE("load/strokes.xopp"));
    ASSERT_TRUE(doc);
...
TEST(ControlLoadHandler, testText) {
    auto doc = loadTestDocument(GET_TESTFILE("load/text.xopp"));
    ASSERT_TRUE(doc);
...
TEST(ControlLoadHandler, testTextZipped) {
    auto doc = loadTestDocument(GET_TESTFILE("packaged_xopp/text.xopp"));
    ASSERT_TRUE(doc);
...
TEST(ControlLoadHandler, testImage) {
    auto doc = loadTestDocument(GET_TESTFILE("load/image.xopp"));
    ASSERT_TRUE(doc);
...
TEST(ControlLoadHandler, testImageZipped) {
    auto doc = loadTestDocument(GET_TESTFILE("packaged_xopp/imgAttachment/new.xopp"));
    ASSERT_TRUE(doc);
...
TEST(ControlLoadHandler, imageLoadJpeg) {
    ...
    auto doc = loadTestDocument(GET_TESTFILE("packaged_xopp/imgAttachment/doc_with_jpg.xopp"));
...
TEST(ControlLoadHandler, testLatex) {
    auto doc = loadTestDocument(GET_TESTFILE("load/latex.xopp"));
    ASSERT_TRUE(doc);
...
TEST(ControlLoadHandler, linebreaksLatex) {
    ...
    {
        auto doc = loadTestDocument(GET_TESTFILE("load/linebreaksLatex.xopp"));
...
TEST(ControlLoadHandler, testStrokeWidthRecovery) {
    auto doc = loadTestDocument(GET_TESTFILE("packaged_xopp/stroke/width_recovery.xopp"));
    ASSERT_TRUE(doc);
...
TEST(ControlLoadHandler, testRelativePath) {
    auto doc = loadTestDocument(GET_TESTFILE("load/relativePaths.xopp"));
