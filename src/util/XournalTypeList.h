...
//XOJ_DECLARE_TYPE(XXXXXXXXXXXXXXXX, 50);
//XOJ_DECLARE_TYPE(XXXXXXXXXXXXXXXX, 51);
//XOJ_DECLARE_TYPE(XXXXXXXXXXXXXXXX, 52);
//XOJ_DECLARE_TYPE(XXXXXXXXXXXXXXXX, 53);
//XOJ_DECLARE_TYPE(XXXXXXXXXXXXXXXX, 54);
//XOJ_DECLARE_TYPE(XXXXXXXXXXXXXXXX, 55);
//XOJ_DECLARE_TYPE(XXXXXXXXXXXXXXXX, 56);
//XOJ_DECLARE_TYPE(XXXXXXXXXXXXXXXX, 57);
//XOJ_DECLARE_TYPE(XXXXXXXXXXXXXXXX, 58);
//XOJ_DECLARE_TYPE(XXXXXXXXXXXXXXXX, 59);
//XOJ_DECLARE_TYPE(XXXXXXXXXXXXXXXX, 6);
