...
auto PaperFormatUtils::createPaperFormatDropDown(const PaperFormatMenuOptionVector_t& menuOptions,
                                                 GtkComboBox* paperFormatComboBox) -> GtkComboBox* {
