...
// const GValue atomToolItem = gdk_atom_intern_static_string("application/xournal-ToolbarItem");
...
//             g_warning("ToolbarDragDropHelper::gdk_context_set_icon_from_image: Image storage GTK_IMAGE_ANIMATION
//             can't "
//                       "be handled");
//             break;
//         }
