...
//     GDK_ACTION_MOVE); ToolbarDragDropHelper::dragSourceAddToolbar(GTK_WIDGET(it));
//
...
//             g_message(
//                     "%s",
//                     FS(_F("Removed tool item {1} from Toolbar {2} ID {3}") % item->getId() % toolbarName %
//                     id).c_str());
//         } else {
...
//         } else {
//             g_message("%s",
//                       FS(_F("Could not remove tool item from Toolbar {1} on position {2}") % toolbarName %
//                       id).c_str());
//         }
//     }
// }
