...
void xoj::input::printGdkEvent(std::ostream& str, GdkEvent* e, guint32 referenceTime) {
    ...
    if (gdk_event_get_event_type(e) == GDK_BUTTON_PRESS || gdk_event_get_event_type(e) == GDK_BUTTON_RELEASE) {
        str << "   Button:      " << gdk_button_event_get_button(e) << "\n";
    }
    if (gdk_event_get_event_type(e) == GDK_KEY_PRESS || gdk_event_get_event_type(e) == GDK_KEY_RELEASE) {
