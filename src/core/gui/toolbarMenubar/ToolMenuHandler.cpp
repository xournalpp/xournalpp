...
void ToolMenuHandler::initToolItems() {
    ...
    emplaceStockItem("NAVIGATE_BACK", Cat::NAVIGATION, Action::NAVIGATE_BACK, "go-previous", _("Jump back"));
    emplaceCustomItem("GOTO_PAGE", Cat::NAVIGATION, Action::GOTO_PAGE, "go-to", _("Go to page"));
    emplaceStockItem("NAVIGATE_FORWARD", Cat::NAVIGATION, Action::NAVIGATE_FORWARD, "go-next", _("Jump forward"));
