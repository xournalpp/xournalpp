...
const char* TOOLBAR_INI_HEADER =
        ...
        "       SELECT_PDF_TEXT_RECT,DRAW_RECTANGLE,DRAW_ELLIPSE,DRAW_ARROW,DRAW_DOUBLE_ARROW,DRAW_COORDINATE_SYSTEM,RULER,DRAW_SPLINE,DRAW_EXP,\n"
        "       DRAW_GAUSS,DRAW_POLY,DRAW_POLYNEG,DRAW_SINUS,SELECT_REGION,SELECT_RECTANGLE,SELECT_MULTILAYER_REGION,\n"
        "       SELECT_MULTILAYER_RECTANGLE,SELECT_OBJECT,VERTICAL_SPACE,PLAY_OBJECT,\n"
