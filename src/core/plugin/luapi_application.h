...
static int applib_uiAction(lua_State* L) {
    ...
    ActionBackwardCompatibilityLayer(plugin->getControl()).actionPerformed(actionStr, enabled);
...
static int applib_layerAction(lua_State* L) {
    ...
    ActionBackwardCompatibilityLayer(plugin->getControl()).actionPerformed(actionStr, true);
