...
static const std::map<std::string_view, std::pair<Action, ToolSize>> TOOL_SIZE_MAP = {
        ...
        {"ACTION_SIZE_CUSTOM"sv, {Action::TOOL_SIZE, TOOL_SIZE_CUSTOM}},
        ...
        {"ACTION_TOOL_ERASER_SIZE_CUSTOM"sv, {Action::TOOL_ERASER_SIZE, TOOL_SIZE_CUSTOM}},
        ...
        {"ACTION_TOOL_PEN_SIZE_CUSTOM"sv, {Action::TOOL_PEN_SIZE, TOOL_SIZE_CUSTOM}},
        ...
        {"ACTION_TOOL_HIGHLIGHTER_SIZE_CUSTOM"sv, {Action::TOOL_HIGHLIGHTER_SIZE, TOOL_SIZE_CUSTOM}}};
