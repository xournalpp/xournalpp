...
XmlTextNode::XmlTextNode(StringUtils::StaticStringView tag, std::string text): XmlNode(tag), text(std::move(text)) {}

XmlTextNode::XmlTextNode(StringUtils::StaticStringView tag): XmlNode(tag) {}
