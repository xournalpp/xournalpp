...
const KeyBindingsGroup<TextEditor>& TextEditor::getDefaultKeyBindings() {
    static KeyBindingsGroup<TextEditor> defaultKeyBindings =
        {move_binding(NONE, Right, GTK_MOVEMENT_VISUAL_POSITIONS, 1),
         ...
         {{CTRL_OR_META & SHIFT, GDK_KEY_KP_Delete}, wrap<&TextEditor::deleteFromCursor, GTK_DELETE_PARAGRAPH_ENDS, 1>},
         {{CTRL_OR_META & SHIFT, GDK_KEY_BackSpace}, wrap<&TextEditor::deleteFromCursor, GTK_DELETE_PARAGRAPH_ENDS, -1>},
