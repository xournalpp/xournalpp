...
const char * TOOLBAR_INI = 	"# Xournal++ Toolbar configuration\n"
	...
	"name = Xournal++\n"
	"name[de] = Xournal++\n"
	"toolbarTop1 = SAVE,NEW,OPEN,INSERT_NEW_PAGE,SEPARATOR, CUT,COPY,PASTE,SEPARATOR, UNDO,REDO,SEPARATOR, PEN,ERASER,HILIGHTER,IMAGE,TEXT,SHAPE_RECOGNIZER,RULER,SEPARATOR, SELECT,VERTICAL_SPACE,HAND,SEPARATOR, FINE,MEDIUM,THICK,SEPARATOR ,COLOR(0xffffff),COLOR(0xffff00),COLOR(0xff8000),COLOR(0xff00ff),COLOR(0x00ff00),COLOR(0x00c0ff),COLOR(0x808080),COLOR(0x008000),COLOR(0xff0000),COLOR(0x3333cc),COLOR(0x000000),COLOR_SELECT, SEPARATOR, SELECT_FONT\n"
	...
	"toolbarTop1 = SAVE,NEW,OPEN,INSERT_NEW_PAGE,SEPARATOR, CUT,COPY,PASTE,SEPARATOR, UNDO,REDO,SEPARATOR, PEN,ERASER,HILIGHTER,IMAGE,TEXT,SHAPE_RECOGNIZER,RULER,SEPARATOR, SELECT,VERTICAL_SPACE,HAND,SEPARATOR, PAGE_SPIN,SEPARATOR, GOTO_FIRST,GOTO_NEXT_ANNOTATED_PAGE,GOTO_LAST,SEPARATOR, LAYER,FULLSCREEN\n"
