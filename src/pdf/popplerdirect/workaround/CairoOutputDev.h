...
public:
	...
	virtual GBool axialShadedSupportExtend(GfxState* state,
	                                       GfxAxialShading* shading);
	virtual GBool radialShadedFill(GfxState* state, GfxRadialShading* shading,
	                               double sMin, double sMax);
	virtual GBool radialShadedSupportExtend(GfxState* state,
	...
	{
		return textClipPath && haveCSPattern;
	}
	...
	void startDoc(XRef* xrefA, Catalog* catalogA,
	              CairoFontEngine* fontEngine = NULL);
	...
	void setInType3Char(GBool inType3Char)
	{
		this->inType3Char = inType3Char;
	}
