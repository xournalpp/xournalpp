...
auto XojPdfDocument::save(fs::path filename, GError** error) -> bool { return doc->save(filename, error); }

auto XojPdfDocument::load(fs::path filename, string password, GError** error) -> bool {
