...
//	}
	...
	{
		LoadHandler handler;
		Document* doc = handler.loadDocument("testfiles/load/pages.xoj");

		CPPUNIT_ASSERT_EQUAL(5, doc->getPageCount());
	}
	...
	{
		LoadHandler handler;
		Document* doc = handler.loadDocument("testfiles/load/layer.xoj");

		CPPUNIT_ASSERT_EQUAL(1, doc->getPageCount());
		PageRef page = doc->getPage(0);

		CPPUNIT_ASSERT_EQUAL(3, (*page).getLayerCount());
	...
	{
		LoadHandler handler;
		Document* doc = handler.loadDocument("testfiles/load/text.xml");
