...
ToolbarAdapter::ToolbarAdapter(GtkWidget* toolbar,
                               String toolbarName,
...
void ToolbarAdapter::toolitemDragBegin(GtkWidget* widget, GdkDragContext* context,
                                       void* unused)
{
 ...
 */
void ToolbarAdapter::toolitemDragEnd(GtkWidget* widget, GdkDragContext* context,
                                     void* unused)
{
...
void ToolbarAdapter::toolitemDragDataGet(GtkWidget* widget, GdkDragContext* context,
...
void ToolbarAdapter::toolbarDragLeafeCb(GtkToolbar* toolbar, GdkDragContext* context,
...
void ToolbarAdapter::toolbarDragDataReceivedCb(GtkToolbar* toolbar,
                                               ...
                                               GtkSelectionData* data, guint info, guint time, ToolbarAdapter* adapter)
{
  ...
  if (d->type == TOOL_ITEM_ITEM)
  {
    bool horizontal = gtk_orientable_get_orientation(GTK_ORIENTABLE(toolbar)) ==
