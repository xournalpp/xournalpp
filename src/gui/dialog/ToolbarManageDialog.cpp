...
void ToolbarManageDialog::treeCellEditedCallback(GtkCellRendererText * renderer, gchar * pathString, gchar * newText, ToolbarManageDialog * dlg) {
	XOJ_CHECK_TYPE_OBJ(dlg, ToolbarManageDialog);
