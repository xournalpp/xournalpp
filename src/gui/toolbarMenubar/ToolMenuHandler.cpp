...
void ToolMenuHandler::initToolItems()
{
	...
	audioSeekForwardsButton = new ToolButton(listener, "ACTION_AUDIO_SEEK_FORWARDS", ACTION_AUDIO_SEEK_FORWARDS, "audio-seek-forwards", _("Forward"));
	addToolItem(audioSeekForwardsButton);
	audioSeekBackwardsButton = new ToolButton(listener, "ACTION_AUDIO_SEEK_BACKWARDS", ACTION_AUDIO_SEEK_BACKWARDS, "audio-seek-backwards", _("Back"));
