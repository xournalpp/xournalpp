...
static void gtk_xoj_int_txt_class_init(GtkXojIntTxtClass* klass)
{
	...
	// TODO low prio: find out what those marhsallers wer used for

	signals[SELECT_ALL] = g_signal_new_class_handler("select-all",
	                                                 G_OBJECT_CLASS_TYPE (widget_class),
	                                                 (GSignalFlags) (G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION),
	                                                 G_CALLBACK (gtk_xoj_int_txt_select_all), NULL, NULL, 
	                                                 NULL,
	                                                 G_TYPE_NONE, 0);
	...
	signals[MOVE_CURSOR] = g_signal_new_class_handler("move-cursor",
	                                                  G_OBJECT_CLASS_TYPE (widget_class),
	                                                  (GSignalFlags) (G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION),
	                                                  G_CALLBACK (gtk_xoj_int_txt_move_cursor), NULL, NULL, 
	                                                  NULL,
	...
	signals[BACKSPACE] = g_signal_new_class_handler("backspace",
	                                                G_OBJECT_CLASS_TYPE (widget_class),
	                                                (GSignalFlags) (G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION),
	                                                G_CALLBACK (gtk_xoj_int_txt_backspace), NULL, NULL,
	                                                NULL,
	                                                G_TYPE_NONE, 0);
	...
	signals[CUT_CLIPBOARD] = g_signal_new_class_handler("cut-clipboard",
	                                                    G_OBJECT_CLASS_TYPE (widget_class),
	                                                    (GSignalFlags) (G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION),
	                                                    G_CALLBACK (gtk_xoj_int_txt_cut_clipboard), NULL, NULL,
	                                                    NULL,
	                                                    G_TYPE_NONE,
	                                                    0);
	...
	signals[COPY_CLIPBOARD] = g_signal_new_class_handler("copy-clipboard",
	                                                     G_OBJECT_CLASS_TYPE (widget_class),
	                                                     (GSignalFlags) (G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION),
	                                                     G_CALLBACK (gtk_xoj_int_txt_copy_clipboard), NULL, NULL,
	                                                     NULL,
	                                                     G_TYPE_NONE,
	                                                     0);
