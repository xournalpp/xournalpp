...
enum ActionType {
    ...
    ACTION_TOOL_ERASER_SIZE_CUSTOM,

    ACTION_TOOL_ERASER_SET_CUSTOM_THICKNESS,
    ...
    ACTION_TOOL_PEN_SIZE_CUSTOM,

    ACTION_TOOL_PEN_SET_CUSTOM_THICKNESS,
    ...
    ACTION_TOOL_HIGHLIGHTER_SIZE_CUSTOM,

    ACTION_TOOL_HIGHLIGHTER_SET_CUSTOM_THICKNESS,
