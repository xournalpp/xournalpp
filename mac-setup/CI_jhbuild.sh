...
download() {
    jhbuild update gtk-4 gtksourceview4 librsvg adwaita-icon-theme hicolor-icon-theme
...
build_gtk() {
    jhbuild build --no-network gtk-4 gtksourceview4 librsvg adwaita-icon-theme hicolor-icon-theme
