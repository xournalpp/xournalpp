...
if (NOT ADVANCED_PDF_EXPORT_POPPLER)
	...
	if (PKG_CONFIG_FOUND)
	    ...
	    find_path(GTK_GLIBCONFIG_INCLUDE_DIR
	        NAMES glibconfig.h
	...
	set(POPPLER_INCLUDE_DIRS ${GTK_INCLUDE_DIRS} ${POPPLER_INCLUDE_DIR} ${POPPLER_GLIB_INCLUDE_DIR})
	set(POPPLER_LIBRARIES ${GTK_LIBRARIES} ${POPPLER_LIBRARY} ${POPPLER_GLIB_LIBRARY})
...
endif (NOT ADVANCED_PDF_EXPORT_POPPLER)
