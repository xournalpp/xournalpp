...
Open a clangarm64 console (**not** the MINGW64 console -- close them if you have any open) and run the following command twice. Reopen the clangarm64 console each time you run the command.
